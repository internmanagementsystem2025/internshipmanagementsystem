...
const InstituteSidebar = ({ darkMode }) => {
  ...
  // Theme configuration to match home page
  const theme = {
  ...
  const navItems = [
    ...
    },
    {
      ...
      key: "institute-add-cv"
    },
    {
      title: "My CVs",
      icon: FiUserCheck,
      route: "/institute-all-aplications",
      key: "institute-all-aplications"
    },
    {
      title: "Bulk CV",
      icon: FiList,
